...
const CryptoPrices=()=>{
    ...
    const url='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcWWh_yhMrwyTo9lISZKPCWHQcksFtxg0i5juMVeiw&s'
    const images = [
        {
            original: url,
            thumbnail: url,
    ...
    return(
        <div className="col-md-12">
            ...
            <div className="mt-2 text-center">
                <Slider {...settings}>
                    <div className="m-2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5JljziOVHMy_58984OMm1I9fml8Oy7cKMlfebzA5c&s" alt="img"/>
                        <h3>Test Name</h3>
                    </div>
                    <div className="m-2">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5JljziOVHMy_58984OMm1I9fml8Oy7cKMlfebzA5c&s" alt="img"/>
